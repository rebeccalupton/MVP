...
export default function HomePage() {
    ...
    return (
     ...
     <div className="background" style={{ backgroundImage: `url(${backgroundImage})` }}>
      ...
      <div className= "homepage-buttons"> <Link to="/VolunteerView"><button>Join us and sign up</button></Link>
      <Link to="/StaffView"><button>List of volunteers signed up</button></Link></div>
      ...
      <p>
       ...
       Volunteering with The Giving Project provides a direct and tangible impact on the lives of those experiencing homelessness in Barcelona. Your efforts contribute to providing nourishing meals, care packages, and essential items to individuals in need, making a positive difference in their daily lives.
      </p>
       <p>2. Building Meaningful Connections:
       Joining our community of dedicated volunteers allows you to build meaningful connections with like-minded individuals who share a common goal of making a positive change. The shared experience of giving back creates bonds that go beyond the act of volunteering itself.
       </p>
       <p>3. Fostering Empathy and Understanding:
       The Giving Project emphasizes the importance of empathy and understanding in tackling issues related to homelessness. Volunteering exposes you to different perspectives and helps break down stereotypes, fostering a greater sense of compassion and empathy towards marginalized communities.
      </p>
       <p>4. Flexible and Convenient Commitment:
       We understand the demands of daily life, and that's why The Giving Project offers flexible and convenient volunteer shifts on both Saturdays and Sundays. With two shifts available (1-3pm or 7-9pm), you can choose a time that fits seamlessly into your schedule.
       </p>
       <p>5. Personal Growth and Development:
       Volunteering provides an opportunity for personal growth and development. Whether it's your first time or you're a seasoned volunteer, being part of The Giving Project offers a chance to enhance your leadership, organizational, and communication skills in a dynamic and supportive environment.
      </p>
